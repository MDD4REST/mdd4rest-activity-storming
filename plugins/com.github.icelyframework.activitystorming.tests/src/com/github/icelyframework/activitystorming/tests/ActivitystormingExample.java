...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>activitystorming</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivitystormingExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ActivitystormingPackage.eNS_URI, 
			 ActivitystormingPackage.eINSTANCE);
