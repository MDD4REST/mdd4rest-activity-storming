...
public class ActivityEdgeReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		if (!(getLink().eContainer() instanceof ActivityDiagram)) {
			return false;
		}
		ActivityDiagram container = (ActivityDiagram) getLink().eContainer();
		return ActivitystormingBaseItemSemanticEditPolicy.getLinkConstraints().canExistActivityEdge_4005(container,
