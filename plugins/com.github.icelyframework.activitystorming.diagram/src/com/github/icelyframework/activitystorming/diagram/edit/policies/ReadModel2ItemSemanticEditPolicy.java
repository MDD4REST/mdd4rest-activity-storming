 ...
 * @generated
 */
public class ReadModel2ItemSemanticEditPolicy extends ActivitystormingBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ReadModel2ItemSemanticEditPolicy() {
		super(ActivitystormingElementTypes.ReadModel_3019);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ActivitystormingVisualIDRegistry.getVisualID(incomingLink) == SupplierReadmodelsEditPart.VISUAL_ID) {
			...
			if (ActivitystormingVisualIDRegistry.getVisualID(incomingLink) == DomainEventReadmodelEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
