...
import com.github.icelyframework.activitystorming.diagram.edit.policies.Entity2ItemSemanticEditPolicy;
...
public class Entity2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EntityName2EditPart) {
			((EntityName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureEntityLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ActivitystormingVisualIDRegistry.getType(EntityName2EditPart.VISUAL_ID));
	}
