...
public class ControlFlowCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	private final ActivityDiagram container;
	...
	*/
	public boolean canExecute() {
		...
		return ActivitystormingBaseItemSemanticEditPolicy.getLinkConstraints().canCreateControlFlow_4003(getContainer(),
				getSource(), getTarget());
	}
	...
	* @generated
	*/
	public ActivityDiagram getContainer() {
		return container;
	}
	...
	* @generated
	*/
	private static ActivityDiagram deduceContainer(EObject source, EObject target) {
		// Find container element for the new link.
		// Climb up by containment hierarchy starting from the source
		// and return the first element that is instance of the container class.
		for (EObject element = source; element != null; element = element.eContainer()) {
			if (element instanceof ActivityDiagram) {
				return (ActivityDiagram) element;
			}
		}
		return null;
	}
