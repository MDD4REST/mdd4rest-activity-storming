...
public class ActivityPartitionActivityPartitionActivitynodeCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ActivitystormingNodeDescriptor> childDescriptors = ActivitystormingDiagramUpdater
				.getActivityPartitionActivityPartitionActivitynodeCompartment_7005SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<ActivitystormingNodeDescriptor> childDescriptors = ActivitystormingDiagramUpdater
				.getActivityPartitionActivityPartitionActivitynodeCompartment_7005SemanticChildren(
