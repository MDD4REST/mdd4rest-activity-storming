...
public class ExternalSystem2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ActivitystormingPackage.eINSTANCE.getSupplier_Constraints();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ActivitystormingNodeDescriptor> childDescriptors = ActivitystormingDiagramUpdater
				.getExternalSystem_3010SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ConstraintPin2EditPart.VISUAL_ID == ActivitystormingVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ActivitystormingNodeDescriptor> childDescriptors = ActivitystormingDiagramUpdater
				.getExternalSystem_3010SemanticChildren((View) getHost().getModel());
