 ...
 * @generated
 */
public class ConstraintPin3ItemSemanticEditPolicy extends ActivitystormingBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ConstraintPin3ItemSemanticEditPolicy() {
		super(ActivitystormingElementTypes.ConstraintPin_3011);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ActivitystormingVisualIDRegistry.getVisualID(outgoingLink) == ConstraintPinTriggersEditPart.VISUAL_ID) {
