...
public class ActivitystormingModelingAssistantProviderOfDomainEvent2EditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((DomainEvent2EditPart) sourceEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSource(DomainEvent2EditPart source) {
		...
		types.add(ActivitystormingElementTypes.DomainEventReadmodel_4010);
		return types;
	}
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((DomainEvent2EditPart) sourceEditPart, targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(DomainEvent2EditPart source,
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((DomainEvent2EditPart) sourceEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(DomainEvent2EditPart source, IElementType relationshipType) {
		...
		if (relationshipType == ActivitystormingElementTypes.ObjectFlow_4001) {
			...
			types.add(ActivitystormingElementTypes.DomainEvent_3020);
			types.add(ActivitystormingElementTypes.ControlNode_3021);
		} else if (relationshipType == ActivitystormingElementTypes.DomainEventReadmodel_4010) {
			types.add(ActivitystormingElementTypes.ReadModel_2015);
			types.add(ActivitystormingElementTypes.ReadModel_3019);
		}
		return types;
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((DomainEvent2EditPart) targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnTarget(DomainEvent2EditPart target) {
		...
		types.add(ActivitystormingElementTypes.ConstraintPinTriggers_4011);
		return types;
	}
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((DomainEvent2EditPart) targetEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(DomainEvent2EditPart target, IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == ActivitystormingElementTypes.ObjectFlow_4001) {
			types.add(ActivitystormingElementTypes.CommandAction_2001);
			types.add(ActivitystormingElementTypes.Aggregate_2002);
			...
			types.add(ActivitystormingElementTypes.Aggregate_3006);
			types.add(ActivitystormingElementTypes.ExternalSystem_3010);
		} else if (relationshipType == ActivitystormingElementTypes.ConstraintPinTriggers_4011) {
			types.add(ActivitystormingElementTypes.ConstraintPin_2007);
			types.add(ActivitystormingElementTypes.ConstraintPin_3001);
			types.add(ActivitystormingElementTypes.ConstraintPin_3011);
		}
