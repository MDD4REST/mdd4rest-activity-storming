 ...
 * @generated
 */
public class DomainEventNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DomainEventNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ActivitystormingParserProvider.getParser(ActivitystormingElementTypes.DomainEvent_2016,
					getParserElement(), ActivitystormingVisualIDRegistry.getType(
							com.github.icelyframework.activitystorming.diagram.edit.parts.DomainEventNameEditPart.VISUAL_ID));
		}
		return parser;
	}
