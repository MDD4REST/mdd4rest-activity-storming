...
import com.github.icelyframework.activitystorming.diagram.edit.policies.EntityItemSemanticEditPolicy;
...
public class EntityEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EntityNameEditPart) {
			((EntityNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureEntityLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ActivitystormingVisualIDRegistry.getType(EntityNameEditPart.VISUAL_ID));
	}
