...
public class WrappingLabel2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ActivitystormingVisualIDRegistry.getType(
						com.github.icelyframework.activitystorming.diagram.edit.parts.WrappingLabel2EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ActivitystormingParserProvider.getParser(ActivitystormingElementTypes.SupplierTriggers_4008,
