...
public class AggregateAggregateDomainobjectCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ActivitystormingPackage.eINSTANCE.getAggregate_Domainobject();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ActivitystormingNodeDescriptor> childDescriptors = ActivitystormingDiagramUpdater
				.getAggregateAggregateDomainobjectCompartment_7003SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == ValueObject2EditPart.VISUAL_ID || visualID == Entity2EditPart.VISUAL_ID
				|| visualID == DomainObject2EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ActivitystormingNodeDescriptor> childDescriptors = ActivitystormingDiagramUpdater
				.getAggregateAggregateDomainobjectCompartment_7003SemanticChildren((View) getHost().getModel());
