...
public class ForkNodeCreateCommand extends EditElementCommand {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		ForkNode newElement = ActivitystormingFactory.eINSTANCE.createForkNode();
	...
	* @generated
	*/
	protected void doConfigure(ForkNode newElement, IProgressMonitor monitor, IAdaptable info)
