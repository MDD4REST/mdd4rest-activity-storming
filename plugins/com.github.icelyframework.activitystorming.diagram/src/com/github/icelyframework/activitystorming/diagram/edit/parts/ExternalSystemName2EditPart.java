 ...
 * @generated
 */
public class ExternalSystemName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ExternalSystemName2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return ActivitystormingElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ActivitystormingParserProvider.getParser(ActivitystormingElementTypes.ExternalSystem_3010,
					getParserElement(), ActivitystormingVisualIDRegistry.getType(
							com.github.icelyframework.activitystorming.diagram.edit.parts.ExternalSystemName2EditPart.VISUAL_ID));
		}
		return parser;
	}
