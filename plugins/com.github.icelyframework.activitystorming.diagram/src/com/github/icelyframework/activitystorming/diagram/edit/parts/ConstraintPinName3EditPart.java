...
import com.github.icelyframework.activitystorming.diagram.edit.policies.ActivitystormingTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ConstraintPinName3EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(ActivitystormingVisualIDRegistry.getType(
				com.github.icelyframework.activitystorming.diagram.edit.parts.ConstraintPinName3EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ConstraintPinName3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new ActivitystormingTextSelectionEditPolicy());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ActivitystormingParserProvider.getParser(ActivitystormingElementTypes.ConstraintPin_3011,
					getParserElement(), ActivitystormingVisualIDRegistry.getType(
							com.github.icelyframework.activitystorming.diagram.edit.parts.ConstraintPinName3EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ActivitystormingEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ConstraintPinLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ConstraintPinLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ConstraintPinLabelFigure() {
			this.setText("ConstraintPin");
		}
