 ...
 * @generated
 */
public class ActivityPartitionItemSemanticEditPolicy extends ActivitystormingBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ActivityPartitionItemSemanticEditPolicy() {
		super(ActivitystormingElementTypes.ActivityPartition_2020);
	}
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			case ActivityPartitionActivityPartitionActivitynodeCompartmentEditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					switch (ActivitystormingVisualIDRegistry.getVisualID(cnode)) {
					case CommandAction2EditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							Edge incomingLink = (Edge) it.next();
							if (ActivitystormingVisualIDRegistry
									.getVisualID(incomingLink) == ObjectFlowEditPart.VISUAL_ID) {
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(incomingLink) == ObjectFlow2EditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
								continue;
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(incomingLink) == ControlFlowEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
								continue;
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(incomingLink) == ControlFlow2EditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
								continue;
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(incomingLink) == ActivityEdge2EditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
								continue;
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(outgoingLink) == ObjectFlowEditPart.VISUAL_ID) {
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(outgoingLink) == ObjectFlow2EditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
								continue;
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(outgoingLink) == ControlFlowEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
								continue;
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(outgoingLink) == ControlFlow2EditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
								continue;
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(outgoingLink) == ActivityEdge2EditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
								continue;
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(outgoingLink) == ActionSupplierEditPart.VISUAL_ID) {
					...
					case Aggregate2EditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(incomingLink) == ActionSupplierEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(outgoingLink) == SupplierTriggersEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(outgoingLink) == SupplierReadmodelsEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
					...
					case ReadModel2EditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(incomingLink) == SupplierReadmodelsEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(), null,
										incomingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(incomingLink) == DomainEventReadmodelEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(), null,
										incomingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
					...
					case DomainEvent2EditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(incomingLink) == SupplierTriggersEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(), null,
										incomingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(incomingLink) == ConstraintPinTriggersEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(), null,
										incomingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (ActivitystormingVisualIDRegistry
									.getVisualID(outgoingLink) == DomainEventReadmodelEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
