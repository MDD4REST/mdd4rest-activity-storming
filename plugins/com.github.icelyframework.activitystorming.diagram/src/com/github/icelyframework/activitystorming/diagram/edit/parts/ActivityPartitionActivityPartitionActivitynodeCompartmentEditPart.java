...
import com.github.icelyframework.activitystorming.diagram.edit.policies.ActivityPartitionActivityPartitionActivitynodeCompartmentCanonicalEditPolicy;
import com.github.icelyframework.activitystorming.diagram.edit.policies.ActivityPartitionActivityPartitionActivitynodeCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ActivityPartitionActivityPartitionActivitynodeCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ActivityPartitionActivityPartitionActivitynodeCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ActivityPartitionActivityPartitionActivitynodeCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ActivityPartitionActivityPartitionActivitynodeCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(ActivitystormingVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ActivityPartitionActivityPartitionActivitynodeCompartmentCanonicalEditPolicy());
	}
