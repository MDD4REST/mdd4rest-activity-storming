...
public class ActivityEdge2ReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		if (!(getLink().eContainer() instanceof ActivityPartition)) {
			return false;
		}
		ActivityPartition container = (ActivityPartition) getLink().eContainer();
		return ActivitystormingBaseItemSemanticEditPolicy.getLinkConstraints().canExistActivityEdge_4006(container,
