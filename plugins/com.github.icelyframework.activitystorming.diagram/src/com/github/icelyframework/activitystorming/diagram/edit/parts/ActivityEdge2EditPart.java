...
import com.github.icelyframework.activitystorming.diagram.edit.policies.ActivityEdge2ItemSemanticEditPolicy;
...
public class ActivityEdge2EditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ActivityEdge2ItemSemanticEditPolicy());
	}
