 ...
 * @generated
 */
public class AggregateName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AggregateName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ActivitystormingParserProvider.getParser(ActivitystormingElementTypes.Aggregate_3006,
					getParserElement(), ActivitystormingVisualIDRegistry.getType(
							com.github.icelyframework.activitystorming.diagram.edit.parts.AggregateName2EditPart.VISUAL_ID));
		}
		return parser;
	}
