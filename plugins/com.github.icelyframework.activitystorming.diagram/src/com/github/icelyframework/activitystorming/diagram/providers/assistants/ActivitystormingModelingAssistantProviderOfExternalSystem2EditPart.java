...
public class ActivitystormingModelingAssistantProviderOfExternalSystem2EditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((ExternalSystem2EditPart) sourceEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSource(ExternalSystem2EditPart source) {
		...
		types.add(ActivitystormingElementTypes.SupplierTriggers_4008);
		types.add(ActivitystormingElementTypes.SupplierReadmodels_4009);
		return types;
	}
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((ExternalSystem2EditPart) sourceEditPart, targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(ExternalSystem2EditPart source,
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((ExternalSystem2EditPart) sourceEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(ExternalSystem2EditPart source, IElementType relationshipType) {
		...
		if (relationshipType == ActivitystormingElementTypes.ObjectFlow_4001) {
			...
			types.add(ActivitystormingElementTypes.DomainEvent_3020);
			types.add(ActivitystormingElementTypes.ControlNode_3021);
		} else if (relationshipType == ActivitystormingElementTypes.SupplierTriggers_4008) {
			types.add(ActivitystormingElementTypes.DomainEvent_2016);
			types.add(ActivitystormingElementTypes.DomainEvent_3020);
		} else if (relationshipType == ActivitystormingElementTypes.SupplierReadmodels_4009) {
			types.add(ActivitystormingElementTypes.ReadModel_2015);
			types.add(ActivitystormingElementTypes.ReadModel_3019);
		}
		return types;
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((ExternalSystem2EditPart) targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnTarget(ExternalSystem2EditPart target) {
		...
		types.add(ActivitystormingElementTypes.ActivityEdge_4005);
		types.add(ActivitystormingElementTypes.ActivityEdge_4006);
		types.add(ActivitystormingElementTypes.ActionSupplier_4007);
		return types;
	}
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((ExternalSystem2EditPart) targetEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(ExternalSystem2EditPart target, IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == ActivitystormingElementTypes.ObjectFlow_4001) {
			types.add(ActivitystormingElementTypes.CommandAction_2001);
			types.add(ActivitystormingElementTypes.Aggregate_2002);
			...
			types.add(ActivitystormingElementTypes.DomainEvent_3020);
			types.add(ActivitystormingElementTypes.ControlNode_3021);
		} else if (relationshipType == ActivitystormingElementTypes.ActionSupplier_4007) {
			types.add(ActivitystormingElementTypes.CommandAction_2001);
			types.add(ActivitystormingElementTypes.QueryAction_2003);
			types.add(ActivitystormingElementTypes.CommandAction_3005);
			types.add(ActivitystormingElementTypes.QueryAction_3007);
