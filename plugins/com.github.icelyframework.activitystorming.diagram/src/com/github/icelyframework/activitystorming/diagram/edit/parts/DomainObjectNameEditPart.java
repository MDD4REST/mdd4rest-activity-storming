...
public class DomainObjectNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ActivitystormingParserProvider.getParser(ActivitystormingElementTypes.DomainObject_2014,
					getParserElement(), ActivitystormingVisualIDRegistry.getType(
							com.github.icelyframework.activitystorming.diagram.edit.parts.DomainObjectNameEditPart.VISUAL_ID));
		}
		return parser;
	}
