...
import com.github.icelyframework.activitystorming.diagram.edit.policies.ActivityPartitionItemSemanticEditPolicy;
...
public class ActivityPartitionEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ActivityPartitionActivityPartitionActivitynodeCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getActivityPartitionActivitynodeCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ActivityPartitionActivityPartitionActivitynodeCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ActivityPartitionActivityPartitionActivitynodeCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getActivityPartitionActivitynodeCompartmentFigure();
			pane.remove(
					((ActivityPartitionActivityPartitionActivitynodeCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ActivityPartitionActivityPartitionActivitynodeCompartmentEditPart) {
