...
import com.github.icelyframework.activitystorming.diagram.edit.policies.Entity3ItemSemanticEditPolicy;
import com.github.icelyframework.activitystorming.diagram.part.ActivitystormingVisualIDRegistry;

/**
 * @generated
 */
public class Entity3EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EntityName3EditPart) {
			((EntityName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureEntityLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ActivitystormingVisualIDRegistry.getType(EntityName3EditPart.VISUAL_ID));
	}
