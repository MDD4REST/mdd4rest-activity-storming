...
public class ObjectFlow2CreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return ActivitystormingBaseItemSemanticEditPolicy.getLinkConstraints().canCreateObjectFlow_4002(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ObjectFlow newElement = ActivitystormingFactory.eINSTANCE.createObjectFlow();
	...
	* @generated
	*/
	protected void doConfigure(ObjectFlow newElement, IProgressMonitor monitor, IAdaptable info)
