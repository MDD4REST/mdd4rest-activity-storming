...
import com.github.icelyframework.activitystorming.diagram.edit.commands.ConstraintPinTriggersCreateCommand;
import com.github.icelyframework.activitystorming.diagram.edit.commands.ConstraintPinTriggersReorientCommand;
...
import com.github.icelyframework.activitystorming.diagram.edit.commands.DomainEventReadmodelCreateCommand;
import com.github.icelyframework.activitystorming.diagram.edit.commands.DomainEventReadmodelReorientCommand;
 ...
 * @generated
 */
public class DomainEvent2ItemSemanticEditPolicy extends ActivitystormingBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public DomainEvent2ItemSemanticEditPolicy() {
		super(ActivitystormingElementTypes.DomainEvent_3020);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ActivitystormingVisualIDRegistry.getVisualID(incomingLink) == SupplierTriggersEditPart.VISUAL_ID) {
			...
			if (ActivitystormingVisualIDRegistry.getVisualID(incomingLink) == ConstraintPinTriggersEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ActivitystormingVisualIDRegistry.getVisualID(outgoingLink) == DomainEventReadmodelEditPart.VISUAL_ID) {
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (ActivitystormingElementTypes.DomainEventReadmodel_4010 == req.getElementType()) {
			return getGEFWrapper(new DomainEventReadmodelCreateCommand(req, req.getSource(), req.getTarget()));
		}
		if (ActivitystormingElementTypes.ConstraintPinTriggers_4011 == req.getElementType()) {
			return null;
		}
		return null;
	}
	...
	protected Command getCompleteCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (ActivitystormingElementTypes.ConstraintPinTriggers_4011 == req.getElementType()) {
			return getGEFWrapper(new ConstraintPinTriggersCreateCommand(req, req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientReferenceRelationshipCommand(ReorientReferenceRelationshipRequest req) {
		...
		case DomainEventReadmodelEditPart.VISUAL_ID:
			return getGEFWrapper(new DomainEventReadmodelReorientCommand(req));
		case ConstraintPinTriggersEditPart.VISUAL_ID:
			return getGEFWrapper(new ConstraintPinTriggersReorientCommand(req));
		}
