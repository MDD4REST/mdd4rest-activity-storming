 ...
 * @generated
 */
public class DecisionNodeName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(ActivitystormingVisualIDRegistry.getType(
				com.github.icelyframework.activitystorming.diagram.edit.parts.DecisionNodeName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public DecisionNodeName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ActivitystormingParserProvider.getParser(ActivitystormingElementTypes.DecisionNode_3015,
	...
	*/
	protected IFigure createFigurePrim() {
		return new DecisionNodeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class DecisionNodeLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public DecisionNodeLabelFigure() {
