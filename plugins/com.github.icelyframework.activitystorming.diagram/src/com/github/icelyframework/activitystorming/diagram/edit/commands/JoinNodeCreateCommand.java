...
public class JoinNodeCreateCommand extends EditElementCommand {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		JoinNode newElement = ActivitystormingFactory.eINSTANCE.createJoinNode();
	...
	* @generated
	*/
	protected void doConfigure(JoinNode newElement, IProgressMonitor monitor, IAdaptable info)
