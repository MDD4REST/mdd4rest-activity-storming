...
import com.github.icelyframework.activitystorming.diagram.edit.policies.ActorActorActivitynodeCompartmentCanonicalEditPolicy;
import com.github.icelyframework.activitystorming.diagram.edit.policies.ActorActorActivitynodeCompartmentItemSemanticEditPolicy;
...
public class ActorActorActivitynodeCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	*/
	public String getCompartmentName() {
		return Messages.ActorActorActivitynodeCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ActorActorActivitynodeCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(ActivitystormingVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ActorActorActivitynodeCompartmentCanonicalEditPolicy());
	}
