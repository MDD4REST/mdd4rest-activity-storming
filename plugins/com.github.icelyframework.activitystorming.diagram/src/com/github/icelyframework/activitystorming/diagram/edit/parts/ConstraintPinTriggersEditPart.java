...
import com.github.icelyframework.activitystorming.diagram.edit.policies.ConstraintPinTriggersItemSemanticEditPolicy;
...
public class ConstraintPinTriggersEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ConstraintPinTriggersItemSemanticEditPolicy());
	}
