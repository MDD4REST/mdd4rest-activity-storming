 ...
 * @generated
 */
public class ConstraintPinName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(ActivitystormingVisualIDRegistry.getType(
				com.github.icelyframework.activitystorming.diagram.edit.parts.ConstraintPinName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ConstraintPinName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ActivitystormingParserProvider.getParser(ActivitystormingElementTypes.ConstraintPin_3001,
