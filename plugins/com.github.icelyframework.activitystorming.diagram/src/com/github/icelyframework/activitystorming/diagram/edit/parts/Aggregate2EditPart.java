...
import com.github.icelyframework.activitystorming.diagram.edit.policies.Aggregate2CanonicalEditPolicy;
import com.github.icelyframework.activitystorming.diagram.edit.policies.Aggregate2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Aggregate2EditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public Aggregate2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Aggregate2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new Aggregate2CanonicalEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AggregateName2EditPart) {
			((AggregateName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAggregateLabelFigure());
			return true;
		}
		if (childEditPart instanceof AggregateAggregateDomainobjectCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAggregateDomainobjectCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AggregateAggregateDomainobjectCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AggregateAggregateDomainobjectCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAggregateDomainobjectCompartmentFigure();
			pane.remove(((AggregateAggregateDomainobjectCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ConstraintPin2EditPart) {
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof AggregateAggregateDomainobjectCompartment2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ActivitystormingVisualIDRegistry.getType(AggregateName2EditPart.VISUAL_ID));
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == ActivitystormingElementTypes.ValueObject_3002) {
				return getChildBySemanticHint(ActivitystormingVisualIDRegistry
