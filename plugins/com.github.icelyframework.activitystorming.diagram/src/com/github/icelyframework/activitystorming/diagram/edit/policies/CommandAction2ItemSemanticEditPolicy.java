 ...
 * @generated
 */
public class CommandAction2ItemSemanticEditPolicy extends ActivitystormingBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public CommandAction2ItemSemanticEditPolicy() {
		super(ActivitystormingElementTypes.CommandAction_3005);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ActivitystormingVisualIDRegistry.getVisualID(outgoingLink) == ActionSupplierEditPart.VISUAL_ID) {
