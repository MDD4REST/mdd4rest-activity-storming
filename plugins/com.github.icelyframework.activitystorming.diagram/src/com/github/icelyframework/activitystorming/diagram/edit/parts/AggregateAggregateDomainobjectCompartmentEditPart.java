...
import com.github.icelyframework.activitystorming.diagram.edit.policies.AggregateAggregateDomainobjectCompartmentCanonicalEditPolicy;
import com.github.icelyframework.activitystorming.diagram.edit.policies.AggregateAggregateDomainobjectCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AggregateAggregateDomainobjectCompartmentEditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public AggregateAggregateDomainobjectCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AggregateAggregateDomainobjectCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AggregateAggregateDomainobjectCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(ActivitystormingVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AggregateAggregateDomainobjectCompartmentCanonicalEditPolicy());
	}
