...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.activitystorming.ObjectNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectNodeItemProvider extends ActivityNodeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectNode_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectNode_name_feature", "_UI_ObjectNode_type"),
				 ActivitystormingPackage.Literals.OBJECT_NODE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ActivitystormingPackage.Literals.OBJECT_NODE__IS_CONTROL_TYPE,
				 true,
				 false,
				 false,
	...
	protected void addOrderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectNode_order_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectNode_order_feature", "_UI_ObjectNode_type"),
				 ActivitystormingPackage.Literals.OBJECT_NODE__ORDER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ActivitystormingPackage.Literals.OBJECT_NODE__UPPER_BOUND);
			childrenFeatures.add(ActivitystormingPackage.Literals.OBJECT_NODE__VARIABLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ActivitystormingPackage.Literals.OBJECT_NODE__UPPER_BOUND,
				 ActivitystormingFactory.eINSTANCE.createValueSpecification()));

		newChildDescriptors.add
			(createChildParameter
				(ActivitystormingPackage.Literals.OBJECT_NODE__VARIABLES,
