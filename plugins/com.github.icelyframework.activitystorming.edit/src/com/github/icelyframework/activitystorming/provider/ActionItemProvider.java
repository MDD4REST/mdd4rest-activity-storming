...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.activitystorming.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionItemProvider extends ExecutableNodeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ActivitystormingPackage.Literals.ACTION__NAME,
				 true,
				 false,
				 false,
	...
	protected void addSupplierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_supplier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_supplier_feature", "_UI_Action_type"),
				 ActivitystormingPackage.Literals.ACTION__SUPPLIER,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ActivitystormingPackage.Literals.ACTION__INPUTPIN);
			childrenFeatures.add(ActivitystormingPackage.Literals.ACTION__OUTPUTPIN);
			childrenFeatures.add(ActivitystormingPackage.Literals.ACTION__CALLACTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ActivitystormingPackage.Literals.ACTION__INPUTPIN,
				 ActivitystormingFactory.eINSTANCE.createInputPin()));

		newChildDescriptors.add
			(createChildParameter
				(ActivitystormingPackage.Literals.ACTION__OUTPUTPIN,
				 ActivitystormingFactory.eINSTANCE.createOutputPin()));

		newChildDescriptors.add
			(createChildParameter
				(ActivitystormingPackage.Literals.ACTION__CALLACTIONS,
