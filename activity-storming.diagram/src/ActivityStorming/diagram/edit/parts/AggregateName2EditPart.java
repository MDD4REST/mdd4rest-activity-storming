...
public class AggregateName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected Image getLabelIcon() {
		...
		return ActivityStorming.diagram.providers.ActivityStormingElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ActivityStorming.diagram.providers.ActivityStormingParserProvider.getParser(
					ActivityStorming.diagram.providers.ActivityStormingElementTypes.Aggregate_3031, getParserElement(),
