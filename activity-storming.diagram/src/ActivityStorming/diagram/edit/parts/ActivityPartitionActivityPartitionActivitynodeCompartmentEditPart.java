...
public class ActivityPartitionActivityPartitionActivitynodeCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	*/
	public String getCompartmentName() {
		return ActivityStorming.diagram.part.Messages.ActivityPartitionActivityPartitionActivitynodeCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ActivityStorming.diagram.edit.policies.ActivityPartitionActivityPartitionActivitynodeCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(
				ActivityStorming.diagram.part.ActivityStormingVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ActivityStorming.diagram.edit.policies.ActivityPartitionActivityPartitionActivitynodeCompartmentCanonicalEditPolicy());
	}
