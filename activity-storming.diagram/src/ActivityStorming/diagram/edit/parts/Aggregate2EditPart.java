...
public class Aggregate2EditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ActivityStorming.diagram.edit.policies.Aggregate2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ActivityStorming.diagram.edit.policies.Aggregate2CanonicalEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActivityStorming.diagram.edit.parts.AggregateName2EditPart) {
			((ActivityStorming.diagram.edit.parts.AggregateName2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureAggregateLabelFigure());
			return true;
		}
		if (childEditPart instanceof ActivityStorming.diagram.edit.parts.AggregateAggregateDomainobjectCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAggregateDomainobjectCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(
					((ActivityStorming.diagram.edit.parts.AggregateAggregateDomainobjectCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ActivityStorming.diagram.edit.parts.AggregateAggregateDomainobjectCompartment2EditPart) {
