...
public class ConstraintPinName3EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(ActivityStorming.diagram.part.ActivityStormingVisualIDRegistry
				.getType(ActivityStorming.diagram.edit.parts.ConstraintPinName3EditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ActivityStorming.diagram.edit.policies.ActivityStormingTextSelectionEditPolicy());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ActivityStorming.diagram.providers.ActivityStormingParserProvider.getParser(
					ActivityStorming.diagram.providers.ActivityStormingElementTypes.ConstraintPin_3036,
					getParserElement(), ActivityStorming.diagram.part.ActivityStormingVisualIDRegistry
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ActivityStorming.diagram.edit.parts.ActivityStormingEditPartFactory
