...
public class ActivityPartitionEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ActivityStorming.diagram.edit.policies.ActivityPartitionItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActivityStorming.diagram.edit.parts.ActivityPartitionNameEditPart) {
			((ActivityStorming.diagram.edit.parts.ActivityPartitionNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureActivityPartitionLabelFigure());
			return true;
		}
		if (childEditPart instanceof ActivityStorming.diagram.edit.parts.ActivityPartitionActivityPartitionActivitynodeCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getActivityPartitionActivitynodeCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(
					((ActivityStorming.diagram.edit.parts.ActivityPartitionActivityPartitionActivitynodeCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ActivityStorming.diagram.edit.parts.ActivityPartitionActivityPartitionActivitynodeCompartmentEditPart) {
			return getPrimaryShape().getActivityPartitionActivitynodeCompartmentFigure();
		}
	...
	*/
	...
	public class ActivityPartitionFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private RectangleFigure fActivityPartitionActivitynodeCompartmentFigure;
		...
		private void createContents() {
			...
			fActivityPartitionActivitynodeCompartmentFigure = new RectangleFigure();

			fActivityPartitionActivitynodeCompartmentFigure.setOutline(false);

			this.add(fActivityPartitionActivitynodeCompartmentFigure);
		 ...
		 * @generated
		 */
		public RectangleFigure getActivityPartitionActivitynodeCompartmentFigure() {
			return fActivityPartitionActivitynodeCompartmentFigure;
		}
