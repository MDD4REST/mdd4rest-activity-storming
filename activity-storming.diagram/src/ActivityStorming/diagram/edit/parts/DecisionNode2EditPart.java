...
public class DecisionNode2EditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ActivityStorming.diagram.edit.policies.DecisionNode2ItemSemanticEditPolicy());
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ActivityStorming.diagram.edit.parts.DecisionNodeName2EditPart) {
	...
	*/
	...
	public class DecisionNodeFigure extends SVGFigure {
		...
		public DecisionNodeFigure() {
			this.setURI("platform:/plugin/activity-storming/svg/diamond-3.svg");
