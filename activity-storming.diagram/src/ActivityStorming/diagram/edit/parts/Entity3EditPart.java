...
public class Entity3EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ActivityStorming.diagram.edit.policies.Entity3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActivityStorming.diagram.edit.parts.EntityName3EditPart) {
			((ActivityStorming.diagram.edit.parts.EntityName3EditPart) childEditPart)
