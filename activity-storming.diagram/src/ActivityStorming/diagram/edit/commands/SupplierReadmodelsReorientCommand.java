...
public class SupplierReadmodelsReorientCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		if (false == referenceOwner instanceof ActivityStorming.Supplier) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof ActivityStorming.ReadModel && newEnd instanceof ActivityStorming.Supplier)) {
			return false;
		}
		return ActivityStorming.diagram.edit.policies.ActivityStormingBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSupplierReadmodels_4029(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return ActivityStorming.diagram.edit.policies.ActivityStormingBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSupplierReadmodels_4029(getOldSource(), getNewTarget());
	}
	...
	* @generated
	*/
	protected ActivityStorming.Supplier getOldSource() {
		return (ActivityStorming.Supplier) referenceOwner;
	}

	/**
	* @generated
	*/
	protected ActivityStorming.Supplier getNewSource() {
