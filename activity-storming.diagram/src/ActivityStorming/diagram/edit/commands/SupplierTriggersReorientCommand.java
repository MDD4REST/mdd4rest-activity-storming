...
public class SupplierTriggersReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof ActivityStorming.DomainEvent && newEnd instanceof ActivityStorming.Supplier)) {
			return false;
		}
		return ActivityStorming.diagram.edit.policies.ActivityStormingBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSupplierTriggers_4028(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return ActivityStorming.diagram.edit.policies.ActivityStormingBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSupplierTriggers_4028(getOldSource(), getNewTarget());
	}
