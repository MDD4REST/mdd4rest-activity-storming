 ...
 * @generated
 */
public class ObjectFlow2ReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ObjectFlow2ReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ActivityStorming.ObjectFlow) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return ActivityStorming.diagram.edit.policies.ActivityStormingBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectFlow_4022(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		ActivityStorming.ActivityPartition container = (ActivityStorming.ActivityPartition) getLink().eContainer();
		return ActivityStorming.diagram.edit.policies.ActivityStormingBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectFlow_4022(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected ActivityStorming.ObjectFlow getLink() {
		return (ActivityStorming.ObjectFlow) getElementToEdit();
	}
