 ...
 * @generated
 */
public class ControlFlow2ReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ControlFlow2ReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return ActivityStorming.diagram.edit.policies.ActivityStormingBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistControlFlow_4024(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		ActivityStorming.ActivityPartition container = (ActivityStorming.ActivityPartition) getLink().eContainer();
		return ActivityStorming.diagram.edit.policies.ActivityStormingBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistControlFlow_4024(container, getLink(), source, getNewTarget());
	}
