...
public class DomainEventReadmodelCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof ActivityStorming.DomainEvent) {
			return false;
		}
		if (target != null && false == target instanceof ActivityStorming.ReadModel) {
			return false;
		}
		if (getSource() == null) {
		...
		return ActivityStorming.diagram.edit.policies.ActivityStormingBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateDomainEventReadmodel_4030(getSource(), getTarget());
	}
	...
	* @generated
	*/
	protected ActivityStorming.DomainEvent getSource() {
		return (ActivityStorming.DomainEvent) source;
	}

	/**
	* @generated
	*/
	protected ActivityStorming.ReadModel getTarget() {
		return (ActivityStorming.ReadModel) target;
	}
}
