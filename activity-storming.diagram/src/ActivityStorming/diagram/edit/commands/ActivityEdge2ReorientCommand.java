 ...
 * @generated
 */
public class ActivityEdge2ReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ActivityEdge2ReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ActivityStorming.ActivityEdge) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		if (!(getLink().eContainer() instanceof ActivityStorming.ActivityPartition)) {
			return false;
		}
		ActivityStorming.ActivityPartition container = (ActivityStorming.ActivityPartition) getLink().eContainer();
		return ActivityStorming.diagram.edit.policies.ActivityStormingBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActivityEdge_4026(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		ActivityStorming.ActivityPartition container = (ActivityStorming.ActivityPartition) getLink().eContainer();
		return ActivityStorming.diagram.edit.policies.ActivityStormingBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActivityEdge_4026(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected ActivityStorming.ActivityEdge getLink() {
		return (ActivityStorming.ActivityEdge) getElementToEdit();
	}
