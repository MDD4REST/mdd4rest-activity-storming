 ...
 * @generated
 */
public class AggregateAggregateDomainobjectCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ActivityStorming.diagram.part.ActivityStormingNodeDescriptor> childDescriptors = ActivityStorming.diagram.part.ActivityStormingDiagramUpdater
				.getAggregateAggregateDomainobjectCompartment_7007SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<ActivityStorming.diagram.part.ActivityStormingNodeDescriptor> childDescriptors = ActivityStorming.diagram.part.ActivityStormingDiagramUpdater
				.getAggregateAggregateDomainobjectCompartment_7007SemanticChildren((View) getHost().getModel());
