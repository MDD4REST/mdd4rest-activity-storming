 ...
 * @generated
 */
public class Aggregate2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ActivityStorming.diagram.part.ActivityStormingNodeDescriptor> childDescriptors = ActivityStorming.diagram.part.ActivityStormingDiagramUpdater
				.getAggregate_3031SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<ActivityStorming.diagram.part.ActivityStormingNodeDescriptor> childDescriptors = ActivityStorming.diagram.part.ActivityStormingDiagramUpdater
				.getAggregate_3031SemanticChildren((View) getHost().getModel());
