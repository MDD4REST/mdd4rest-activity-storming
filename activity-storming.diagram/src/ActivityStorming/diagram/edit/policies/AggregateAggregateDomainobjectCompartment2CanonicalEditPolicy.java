 ...
 * @generated
 */
public class AggregateAggregateDomainobjectCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ActivityStorming.ActivityStormingPackage.eINSTANCE.getAggregate_Domainobject();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ActivityStorming.diagram.part.ActivityStormingNodeDescriptor> childDescriptors = ActivityStorming.diagram.part.ActivityStormingDiagramUpdater
				.getAggregateAggregateDomainobjectCompartment_7009SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == ActivityStorming.diagram.edit.parts.ValueObject2EditPart.VISUAL_ID
				|| visualID == ActivityStorming.diagram.edit.parts.Entity2EditPart.VISUAL_ID
				|| visualID == ActivityStorming.diagram.edit.parts.DomainObject2EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ActivityStorming.diagram.part.ActivityStormingNodeDescriptor> childDescriptors = ActivityStorming.diagram.part.ActivityStormingDiagramUpdater
				.getAggregateAggregateDomainobjectCompartment_7009SemanticChildren((View) getHost().getModel());
