 ...
 * @generated
 */
public class ExternalSystemCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ActivityStorming.diagram.part.ActivityStormingNodeDescriptor> childDescriptors = ActivityStorming.diagram.part.ActivityStormingDiagramUpdater
				.getExternalSystem_2056SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<ActivityStorming.diagram.part.ActivityStormingNodeDescriptor> childDescriptors = ActivityStorming.diagram.part.ActivityStormingDiagramUpdater
				.getExternalSystem_2056SemanticChildren((View) getHost().getModel());
