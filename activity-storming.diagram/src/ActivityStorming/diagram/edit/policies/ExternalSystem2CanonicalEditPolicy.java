 ...
 * @generated
 */
public class ExternalSystem2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ActivityStorming.ActivityStormingPackage.eINSTANCE.getSupplier_Constraints();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ActivityStorming.diagram.part.ActivityStormingNodeDescriptor> childDescriptors = ActivityStorming.diagram.part.ActivityStormingDiagramUpdater
				.getExternalSystem_3035SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ActivityStorming.diagram.edit.parts.ConstraintPin2EditPart.VISUAL_ID == ActivityStorming.diagram.part.ActivityStormingVisualIDRegistry
				.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ActivityStorming.diagram.part.ActivityStormingNodeDescriptor> childDescriptors = ActivityStorming.diagram.part.ActivityStormingDiagramUpdater
				.getExternalSystem_3035SemanticChildren((View) getHost().getModel());
