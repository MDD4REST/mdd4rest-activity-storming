 ...
 * 
 */
package ActivityStorming.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(ActivityStorming.diagram.part.ActivityStormingDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(ActivityStorming.diagram.part.Messages.MessageFormatParser_InvalidInputError,
