...
public class ValidateAction extends Action {
	...
	*/
	public ValidateAction(IWorkbenchPage page) {
		setText(ActivityStorming.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	*/
	public static void runValidation(View view) {
		try {
			if (ActivityStorming.diagram.part.ActivityStormingDiagramEditorUtil.openDiagram(view.eResource())) {
	...
	*/
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		ActivityStorming.diagram.providers.ActivityStormingValidationProvider.runWithConstraints(txDomain,
				new Runnable() {
	...
	*/
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			ActivityStorming.diagram.providers.ActivityStormingMarkerNavigationProvider.deleteMarkers(target);
		}
	...
	*/
	private static void createMarkers(IFile target, IStatus validationStatus, DiagramEditPart diagramEditPart) {
		...
		ActivityStorming.diagram.part.ActivityStormingDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new ActivityStorming.diagram.part.ActivityStormingDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(),
				collectTargetElements(rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = ActivityStorming.diagram.part.ActivityStormingDiagramEditorUtil.findView(diagramEditPart,
	...
	*/
	private static void addMarker(EditPartViewer viewer, IFile target, String elementId, String location,
		...
		ActivityStorming.diagram.providers.ActivityStormingMarkerNavigationProvider.addMarker(target, elementId,
