...
public class ActivityStormingValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = ActivityStorming.diagram.part.ActivityStormingDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed)
					.getEditorPart() instanceof ActivityStorming.diagram.part.ActivityStormingDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && ActivityStorming.diagram.edit.parts.ActivityDiagramEditPart.MODEL_ID
