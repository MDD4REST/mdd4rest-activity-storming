...
public class ActivityStormingMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {
	...
	* @generated
	*/
	public static final String MARKER_TYPE = ActivityStorming.diagram.part.ActivityStormingDiagramEditorPlugin.ID
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ActivityStorming.diagram.part.ActivityStormingDiagramEditorUtil.selectElementsInDiagram(editor,
