...
public class ActivityStormingModelingAssistantProviderOfMergeNodeEditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((ActivityStorming.diagram.edit.parts.MergeNodeEditPart) sourceEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSource(ActivityStorming.diagram.edit.parts.MergeNodeEditPart source) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((ActivityStorming.diagram.edit.parts.MergeNodeEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			ActivityStorming.diagram.edit.parts.MergeNodeEditPart source, IGraphicalEditPart targetEditPart) {
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((ActivityStorming.diagram.edit.parts.MergeNodeEditPart) sourceEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(ActivityStorming.diagram.edit.parts.MergeNodeEditPart source,
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((ActivityStorming.diagram.edit.parts.MergeNodeEditPart) targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnTarget(ActivityStorming.diagram.edit.parts.MergeNodeEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(6);
		types.add(ActivityStorming.diagram.providers.ActivityStormingElementTypes.ObjectFlow_4021);
		types.add(ActivityStorming.diagram.providers.ActivityStormingElementTypes.ObjectFlow_4022);
		types.add(ActivityStorming.diagram.providers.ActivityStormingElementTypes.ControlFlow_4023);
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((ActivityStorming.diagram.edit.parts.MergeNodeEditPart) targetEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(ActivityStorming.diagram.edit.parts.MergeNodeEditPart target,
			IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == ActivityStorming.diagram.providers.ActivityStormingElementTypes.ObjectFlow_4021) {
			types.add(ActivityStorming.diagram.providers.ActivityStormingElementTypes.CommandAction_2051);
