 ...
 * @generated
 */
public class ActivityStormingDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public ActivityStormingDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ActivityStorming.diagram.navigator.ActivityStormingDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((ActivityStorming.diagram.navigator.ActivityStormingDomainNavigatorItem) parentElement)
							.getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ActivityStorming.diagram.navigator.ActivityStormingDomainNavigatorItem(
